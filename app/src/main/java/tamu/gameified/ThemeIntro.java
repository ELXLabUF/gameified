...
public class ThemeIntro extends FragmentActivity implements
    ...
    public void verifyStoragePermissions(Activity activity) {
        ...
        int permissionVibrate = ActivityCompat.checkSelfPermission(activity, Manifest.permission.VIBRATE);

        if (permission != PackageManager.PERMISSION_GRANTED || permissionRecord != PackageManager.PERMISSION_GRANTED || permissionVibrate != PackageManager.PERMISSION_GRANTED) {
