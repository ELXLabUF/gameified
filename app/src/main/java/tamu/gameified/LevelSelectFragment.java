...
public class LevelSelectFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        System.out.println("currentRecordingPlace: " + currentRecordingPlace);
        ...
        if(numberRecordings > 0){
            ...
            leftStar.setImageResource(R.drawable.star_filled);
        }
        if(numberRecordings > 1){
            ImageView middleStar = (ImageView) v.findViewById(R.id.starMiddle);
            middleStar.setImageResource(R.drawable.star_filled);
        }
        if(numberRecordings > 2){
            ImageView rightStar = (ImageView) v.findViewById(R.id.starRight);
            rightStar.setImageResource(R.drawable.star_filled);
        }

        for(int i = 0; i < ChapterDataSingleton.getSync(this.getContext()).getListOfNumberRecordings().size(); i++){
            System.out.println(i + "-- " + ChapterDataSingleton.getSync(this.getContext()).getNumberOfRecordings(i));
        }
