...
public class ThemeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((TextView)v.findViewById(R.id.themeName)).setText("START!"); //changing this for the purpose of the study
    ...
    public void updateThemeImageButton(final String mParam1, View v){
        ...
        if(mParam1.equals("Spy")){
            ...
            Drawable tempImage = ContextCompat.getDrawable(getActivity(), R.drawable.roundedbutton); //changing this for the purpose of the study
            btn = (ImageButton)v.findViewById(R.id.themeImage);
            btn.setImageDrawable(tempImage);
            btn.setOnClickListener(new View.OnClickListener() {
                @Override
